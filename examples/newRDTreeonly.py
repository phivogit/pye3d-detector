...
class CamThread(threading.Thread):
    def __init__(self, preview_name, cam_id, resolution, is_eye_cam=False, focal_length=None, shared_gaze_data=None, camera_matrix=None, dist_coeffs=None, rf_model=None):
    ...
    def predict_gaze_point(self, gaze_normal):
        ...
        prediction = self.rf_model.predict([gaze_normal])[0]
...
def load_random_forest_model():
    try:
        rf_model = joblib.load('randomforestmodel.joblib')
