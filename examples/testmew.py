...
class EyeCamThread(threading.Thread):
    def __init__(self, cam_id, resolution, focal_length, shared_gaze_data, mixed_model):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Dual camera eye tracking system with mixed model and ArUco marker detection")
