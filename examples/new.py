...
class CamThread(threading.Thread):
    def __init__(self, preview_name, cam_id, resolution, is_eye_cam=False, focal_length=None, shared_gaze_data=None, camera_matrix=None, dist_coeffs=None, mixed_model=None):
    ...
    def predict_gaze_point(self, gaze_normal):
        if self.mixed_model is None:
            return self.project_gaze_to_2d(gaze_normal)
...
def main(args):
    ...
    # Load the pre-trained mixed model
    mixed_model = load_mixed_model()
