...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Eye and Hand Control System with MJPEG-Streamer at Full Resolution")
    parser.add_argument("--eye_stream", type=str, default="http://192.168.89.68:8081/?action=stream")
    parser.add_argument("--front_stream", type=str, default="http://192.168.89.68:8080/?action=stream")
    ...
    parser.add_argument("--device_ip", type=str, default="192.168.89.148")
