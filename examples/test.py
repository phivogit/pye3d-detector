...
class EyeCamThread(threading.Thread):
    def __init__(self, cam_id, resolution, focal_length, shared_gaze_data, lr_model):
...
def load_linear_regression_model():
    try:
        lr_model = joblib.load('linearregressionmodel00.joblib')
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Dual camera eye tracking system with ArUco marker detection")
